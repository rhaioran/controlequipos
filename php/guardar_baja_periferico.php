...
$codigoperiferico = $_GET['codigoperiferico'];
...
$sql="SELECT
												perifericos.codigoperiferico,
												perifericos.tipoperiferico,
												perifericos.descripcionperiferico,
												...
												locacion
												WHERE
												perifericos.codigoperiferico = '$codigoperiferico' AND
												perifericos.codigoequipo =  equipos.codigoequipo AND
                                               ...
                                               //echo 'dara????';
                                                while ($dato=mysqli_fetch_array($res))
												{
													...
													$tipoperiferico = $dato['tipoperiferico'];
													$descripcionperiferico = $dato['descripcionperiferico'];
												} 
//echo $codigopieza;//
...
$nomdir = 'baja';
$comentario = "El Periferico ".$tipoperiferico." ".$descripcionperiferico." perteneciente al equipo ".$tipoequipo." ".$descripcionequipo."del funcionario ".$nombrepersona." ".$apellidopaterno." ".$apellidomaterno." con carnet de identidad ".
...
if(mysqli_num_rows($res2))
	{
		...
		{
			$guardar= ("UPDATE perifericos SET codigoperiferico='$codigoperiferico',tipoperiferico='$tipoperiferico', descripcionperiferico='$descripcionperiferico', codigoequipo='$ci' WHERE codigoperiferico='$codigoperiferico'");
