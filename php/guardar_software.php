...
$insertar = mysqli_query($conexion,"INSERT INTO software (tipo,descripcion,codigoequipo)
VALUES ('{$tipo}','{$descripcion}','{$codigoequipo}')");
	...
	echo "	<html>
				<head>
					<meta http-equiv='REFRESH'content='0;url=index_314.php?codigoequipo=$codigoequipo'>
				</head>
				</html>";
	 } 
