                ...
                <div class="">
                    <div class="grid simple">
                        ...
                        <div class="grid-body no-border">
                            <form action="modificar_contrasena.php" method="post" id="form_traditional_validation">  
                                <div class="form-group">
                                    <label class="form-label">Login:</label>
                                    <span class="help">"Registre un nombre de usuario"</span>
                                    <div class="input-with-icon  right">                                       
                                        <i class=""></i>
                                        <input type="text" name="login" id="login" class="form-control" value="<?php echo $nickname ?>" readonly>                                 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="form-label">Password:</label>
                                    <span class="help">"Registre una contraseña"</span>
                                    <div class="input-with-icon  right">                                       
                                        <i class=""></i>
                                ...
                                <div class="form-group">
                                    <label class="form-label">Password:</label>
                                    <span class="help">"Repita su contraseña"</span>
                                    <div class="input-with-icon  right">                                       
                                        <i class=""></i>
