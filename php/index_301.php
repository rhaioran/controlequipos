                    ...
                    <div class="span12">
                        <div class="grid simple ">
                            <div class="grid-title">
                                <h4><span class="semi-bold">PAGOS GENERADOS EN SISTEMA POR LA SUPERVISIÓN</span></h4>
                                <div class="tools"> 
                            ...
                            <div class="grid-body ">   
    <!------------------------------------------------------------------------------------------------------------------------>                                
                                <form class="cmxform form-horizontal " id="" method="post" action="guardar_tramo_de_contrato.php?proyId=<?php echo $proyId ?>">
                                <!--<div  style="height:730px; width:600; overflow-y:auto; overflow:scroll;"">-->
                                <!--<div style="height:700px;overflow:scroll;">-->
                                    <table width="103%" class="table table-hover table-condensed table-striped tab-pane" id="example">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="5%"><h6 align="center" style="color:#666"><b>Certificado / meses</b></h6></th>
                                                <th width="17%"><h6 align="center" style="color:#666"><b>Avance Financiero</b></h6></th>
                                                <th width="20%"><h6 align="center" style="color:#666"><b>Inicio de contrato desde fecha</b></h6></th>
                                            </tr>                 
                                        </thead>
                                        <tbody>
                                            <?php
												...
												habilitada_para_la_gestion = '2015'
                                                ";
                                            ...
                                            <tr>
                                              ...
                                              <?php
												...
												FROM
												contrato_microempresa
												WHERE                    
												cod_microempresa = '$cod' AND habilitado_para_la_gestion='2015' AND tipo_contrato='original'
												",$conexion);
												while($regi=  mysql_fetch_array($lista))
												{
													$total=$regi['total_contrato'];
													$meses=$regi['meses'];
													$desde_fecha=$regi['desde_fecha'];
													$hasta_fecha=$regi['hasta_fecha'];
												} 


											  	$lista=mysql_query("SELECT SUM(monto_cancelado) AS cancelado
												FROM
												micro_pagos_neos
												WHERE                    
												id = '$cod' AND gestion='2015'
												",$conexion);
												while($regi=  mysql_fetch_array($lista))
												{
													$cancelado= $regi['cancelado'];
												}
											  $completado=round((($cancelado/$total)*100),2);
											  ...
											  $lista=mysql_query("SELECT *
												...
												id = '$cod' AND gestion='2015'
												ORDER BY
												micro_pagos_neos.cod_pagos DESC
												LIMIT 1;
												",$conexion);
												while($regi=  mysql_fetch_array($lista))
												{
													$certificado= $regi['n_certificado'];
												}
											  ...
											  ?>
                                              <td align="center"><h6><?php echo ''.$certificado.'/'.$meses.'' ?></h6></td>
                                              <td align="center"><h6><?php echo $completado ?> %</h6></td>
                                              <td align="center"><h6><?php echo ''.$desde_fecha.' al '.$hasta_fecha.'' ?></h6></td>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button class="btn btn-primary" type="submit" onclick='miFuncion()'>Guardar</button>-->
                                        <button class="btn btn-default" type="button"onClick="location='menu_sup_admin.php'">Salir</button>
                                        </div>
                                    </div>
                                <!--</div>-->
                                </form>                    
