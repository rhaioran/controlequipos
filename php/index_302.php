                ...
                <div class="row-fluid">       		
                    <div class="span12">
                        <div class="grid simple ">
                            ...
                            <div><a href="javascript:popup5('index_310.php',700,550)"><img border="0" src="assets/img/usuario.png"width="45" height="45"> Adicionar Usuario</a></div>
                            <br>
    <!------------------------------------------------------------------------------------------------------------------------>                                
                                        ...
                                        <tbody>
                                            <?php
                                                $sql="SELECT
													...
													personas
													WHERE
													usuario.codigopersona =  personas.codigopersona
