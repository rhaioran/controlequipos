...
window.open(url, "index_310u.php",'width='+ancho+',height='+alto+',menubar=0,toolbar=0,directories=0,scrollbars=no,resizable=no,left='+posicion_x+',top='+posicion_y+'');
}
</script>
                ...
                <div class="row-fluid">       		
                    <div class="span12">
                        <div class="grid simple ">
                            ...
                            <div><a href="javascript:popup5('index_310u.php',700,550)"><img border="0" src="assets/img/usuario.png"width="45" height="45"> Adicionar Usuario</a></div>
                            <br>
    <!------------------------------------------------------------------------------------------------------------------------>                                
                                <form class="cmxform form-horizontal " id="" method="post" action="guardar_tramo_de_contrato.php">
                                    ...
                                    <table width="103%" class="table table-hover table-condensed table-striped tab-pane" id="example">
                                        <thead>
                                            <tr>
                                                <th width="5%"><h6 align="center"><b>CI:</b></h6></th>
                                                <th width="10%"><h6 align="center"><b>Apellido Paterno</b></h6></th>
                                                <th width="10%"><h6 align="center"><b>Apellido Materno</b></h6></th>
                                                <th width="10%"><h6 align="center"><b>Nombre</b></h6></th> 
                                                <th width="10%"><h6 align="center"><b>Tipo de usuario</b></h6></th>            
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                unidad
                      													WHERE
                      													usuario.codigopersona =  personas.codigopersona AND
                                                personas.codigodireccion = direcciones.codigodireccion AND
                                                direcciones.codigounidad = unidad.codigounidad AND
                                                unidad.nombreunidad = '$nombreunidad' AND
                      												  unidad.codigolocacion = '$codigolocacion'
                                            ...
                                            <tr>
                                              ...
                                              <td><?php echo utf8_encode($dato["apellidopaterno"]); ?></td>                             
                                              <td><?php echo utf8_encode($dato["apellidomaterno"]); ?></td>
                                              <td><?php echo utf8_encode($dato["nombrepersona"]); ?></td>
                                              <?php 
											  if($dato["tipousuario"]=='0')
                        {
                          $s='Administrador General';
                        }
                        else
                        {
                          if($dato["tipousuario"]=='1')
                          {
                            $s='Invitado';
                          }
                          else
                          {
                            $s='Administrador de Unidad';
                          }
                        }
