                ...
                <div class="row-fluid">       		
                    <div class="span12">
                        <div class="grid simple ">
                            ...
                            <div><a href="javascript:popup5('index_312.php',700,550)"><img border="0" src="assets/img/lapiz.png"width="45" height="45"> Adicionar equipo</a></div>
                            <br>
    <!------------------------------------------------------------------------------------------------------------------------>                                
                                    ...
                                    <table width="103%" class="table table-hover table-condensed table-striped tab-pane" id="example">
                                        ...
                                        <tbody>
                                            <?php
												...
												personas
												WHERE
												equipos.codigopersona =  personas.codigopersona
