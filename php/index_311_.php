    ...
    <!------------------------------------------------------------------------------------------------------------------------>                                
                                <form class="cmxform form-horizontal " id="" method="post" action="guardar_tramo_de_contrato.php">
                                    ...
                                    <table width="103%" class="table table-hover table-condensed table-striped tab-pane" id="example">
                                        <thead>
                                            <tr>
                                            	<th width="7%"><h6 align="center"><b>Codigo de Usuario</b></h6></th>
                                        ...
                                        <tbody>
                                            <?php
												...
												T1.codigoequipo,
												T1.tipoequipo,
												T1.descripcionequipo
												FROM
												equipos T1												
												INNER JOIN historialasignacion T2 ON T1.codigoequipo = T2.codigoequipo
												INNER JOIN 
												(SELECT MAX(fecha) fecha
												FROM
												historialasignacion
												GROUP BY
												codigoequipo) TM ON T2.fecha=TM.fecha												
                                                ";
                                            ...
                                            <tr>
                                              ...
                                              <td><?php echo $dato['codigopersona'] ?></td>        
                                              ...
                                              <td><div align="center"><a href="javascript:popup2('index_313.php?codigoequipo=<?php echo $dato["codigoequipo"] ?>',850,700)"><img border="0" src="assets/img/piezas.png"onMouseOver="this.src='assets/img/piezas.png';" onMouseOut="this.src='assets/img/piezas.png';"width="40" height="40" ></a></div></td>  
                
                                               <td><div align="center"><a href="javascript:popup3('index_314.php?codigoequipo=<?php echo $dato["codigoequipo"] ?>',850,700)"><img border="0" src="assets/img/sistema.png"onMouseOver="this.src='assets/img/sistema.png';" onMouseOut="this.src='assets/img/sistema.png';"width="40" height="40" ></a></div></td>  
                                                <td><div align="center"><a href="javascript:popup4('index_318.php?codigoequipo=<?php echo $dato["codigoequipo"] ?>',850,700)"><img border="0" src="assets/img/folder.png"onMouseOver="this.src='assets/img/folder.png';" onMouseOut="this.src='assets/img/folder.png';"width="40" height="40" ></a></div></td>  
                                                <td><div align="center"><a href="javascript:popup4('index_318.php?codigoequipo=<?php echo $dato["codigoequipo"] ?>',850,700)"><img border="0" src="assets/img/perifericos.png"onMouseOver="this.src='assets/img/perifericos.png';" onMouseOut="this.src='assets/img/perifericos.png';"width="40" height="40" ></a></div></td>  
