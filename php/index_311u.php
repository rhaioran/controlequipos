...
window.open(url, "index_312u.php",'width='+ancho+',height='+alto+',menubar=0,toolbar=0,directories=0,scrollbars=no,resizable=no,left='+posicion_x+',top='+posicion_y+'');
}
</script>
...
posicion_x=(screen.width/2)-(ancho/2); 
posicion_y=(screen.height/2)-(alto/2); 
window.open(url, "index_313.php",'width='+ancho+',height='+alto+',menubar=0,toolbar=0,directories=0,scrollbars=no,resizable=no,left='+posicion_x+',top='+posicion_y+'');
}
</script>
...
posicion_x=(screen.width/2)-(ancho/2); 
posicion_y=(screen.height/2)-(alto/2); 
window.open(url, "index_314.php",'width='+ancho+',height='+alto+',menubar=0,toolbar=0,directories=0,scrollbars=no,resizable=no,left='+posicion_x+',top='+posicion_y+'');
}
</script>

</script>
<script type="text/javascript">
function popup4(url,ancho,alto) 
{
var posicion_x; 
var posicion_y; 
posicion_x=(screen.width/2)-(ancho/2); 
posicion_y=(screen.height/2)-(alto/2); 
window.open(url, "index_318.php",'width='+ancho+',height='+alto+',menubar=0,toolbar=0,directories=0,scrollbars=no,resizable=no,left='+posicion_x+',top='+posicion_y+'');
}
</script>
...
posicion_x=(screen.width/2)-(ancho/2); 
posicion_y=(screen.height/2)-(alto/2); 
window.open(url, "index_324.php",'width='+ancho+',height='+alto+',menubar=0,toolbar=0,directories=0,scrollbars=no,resizable=no,left='+posicion_x+',top='+posicion_y+'');
}
</script>
...
<script type="text/javascript">
function popup6(url,ancho,alto) 
{
var posicion_x; 
var posicion_y; 
posicion_x=(screen.width/2)-(ancho/2); 
posicion_y=(screen.height/2)-(alto/2); 
window.open(url, "index_335.php",'width='+ancho+',height='+alto+',menubar=0,toolbar=0,directories=0,scrollbars=no,resizable=no,left='+posicion_x+',top='+posicion_y+'');
}
</script>

</script>
<script type="text/javascript">
function popup7(url,ancho,alto) 
{
var posicion_x; 
var posicion_y; 
posicion_x=(screen.width/2)-(ancho/2); 
...
var alto_2;
alto_2=(alto/2);
window.open(url, "index_336.php",'width='+ancho+',height='+alto_2+',menubar=0,toolbar=0,directories=0,scrollbars=no,resizable=no,left='+posicion_x+',top='+posicion_(+'')/100)
</script>
			...
			<ul class="nav pull-left notifcation-center" id="main-menu-toggle-wrapper" style="display:none">	
      		...
      		<ul class="nav pull-right notifcation-center">	
        		<li class="dropdown" id="header_task_bar"> 
                	<a href="menu_administracionu.php" class="dropdown-toggle active" data-toggle=""> 
                ...
                <div class="row-fluid">       		
                    <div class="span12">
                        <div class="grid simple ">
                            ...
                            <div><a href="javascript:popup5('index_312u.php',700,550)"><img border="0" src="assets/img/lapiz.png"width="45" height="45"> Adicionar equipo</a></div>
                            <br>
    <!------------------------------------------------------------------------------------------------------------------------>                                
                                <form class="cmxform form-horizontal " id="" method="post" action="guardar_tramo_de_contrato.php">
                                    ...
                                    <table width="103%" class="table table-hover table-condensed table-striped tab-pane" id="example">
                                            ...
                                            <tr>
                                                ...
                                                <th width="15%"><h6 align="center"><b>Descripcion del equipo</b></h6></th>
                                                 <th width="3%"><h6 align="center"><b>Piezas</b></h6></th>
                                                  ...
                                                  <th width="3%"><h6 align="center"><b>Perifericos</b></h6></th>
                                                  <th width="3%"><h6 align="center"><b>Dar de Baja</b></h6></th>
                                                  <th width="3%"><h6 align="center"><b>Transferir</b></h6></th>
                                        ...
                                        <tbody>
                                            ...
                                            <td><?php echo ''.utf8_encode($dato["apellidopaterno"]).' '.utf8_encode($dato["apellidomaterno"]).' '.utf8_encode($dato["nombrepersona"]).'' ?></td>             
                                              ...
                                              <td><div align="center"><a href="javascript:popup2('index_313.php?codigoequipo=<?php echo $dato["codigoequipo"] ?>',850,600)"><img border="0" src="assets/img/piezas.png"onMouseOver="this.src='assets/img/piezas.png';" onMouseOut="this.src='assets/img/piezas.png';"width="40" height="40" ></a></div></td>  
                
                                               <td><div align="center"><a href="javascript:popup3('index_314.php?codigoequipo=<?php echo $dato["codigoequipo"] ?>',850,600)"><img border="0" src="assets/img/sistema.png"onMouseOver="this.src='assets/img/sistema.png';" onMouseOut="this.src='assets/img/sistema.png';"width="40" height="40" ></a></div></td>  
                                                <td><div align="center"><a href="javascript:popup4('index_318.php?codigoequipo=<?php echo $dato["codigoequipo"] ?>',850,600)"><img border="0" src="assets/img/folder.png"onMouseOver="this.src='assets/img/folder.png';" onMouseOut="this.src='assets/img/folder.png';"width="40" height="40" ></a></div></td>  
                                                <td><div align="center"><a href="javascript:popup5('index_324.php?codigoequipo=<?php echo $dato["codigoequipo"] ?>',850,600)"><img border="0" src="assets/img/perifericos.png"onMouseOver="this.src='assets/img/perifericos.png';" onMouseOut="this.src='assets/img/perifericos.png';"width="40" height="40" ></a></div></td>  
                                                
                                                <td><div align="center"><a href="javascript:popup6('index_335.php?codigoequipo=<?php echo $dato["codigoequipo"] ?>',700,500)"><img border="0" src="assets/img/baja.png"onMouseOver="this.src='assets/img/baja.png';" onMouseOut="this.src='assets/img/baja.png';"width="40" height="40" ></a></div></td>  
                                                
                                                <td><div align="center"><a href="javascript:popup6('index_336.php?codigoequipo=<?php echo $dato["codigoequipo"] ?>',700,500)"><img border="0" src="assets/img/asignar.png"onMouseOver="this.src='assets/img/asignar.png';" onMouseOut="this.src='assets/img/asignar.png';"width="40" height="40" ></a></div></td>  
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button class="btn btn-primary" type="submit" onclick='miFuncion()'>Guardar</button>-->
                                        <button class="btn btn-default" type="button"onClick="location='menu_administracionu.php'">Salir</button>
                                        </div>
                                    </div>
                                <!--</div>-->
                                </form>                    
