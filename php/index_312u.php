...
<?php
include("coneccion_bd.php");
  $sql="SELECT idequipos,tipoequipo FROM tipoequipos ORDER BY tipoequipo ASC";
...
include("coneccion_bd.php");
  ...
  unidad.codigolocacion = '$codigolocacion' AND
  personas.nombrepersona != 'baja'
  ...
  while ($row=mysqli_fetch_array($result)) 
  {  
  	$id		= $row["codigopersona"];
  	$name	= utf8_encode(ucwords ($row["nombrepersona"]));
	$name2	= utf8_encode(ucwords ($row["apellidopaterno"]));
	$name3	= utf8_encode(ucwords ($row["apellidomaterno"]));
  	$options.='<option value='.$id.'>'.$name2.' '.$name3.' '.$name.'</option>';
  }
?>
    ...
    <div class="content">
        <!-- BEGIN SAMPLE PORTLET CONFIGURATION MODAL FORM-->
            ...
            <div class="page-title"> 
                ...
                <h3><span class="semi-bold">Registrar Nueva Insidencia</span></h3>
            </div>  
            <div class="row">
                <div class="">
                    <div class="grid simple">
                        ...
                        <div class="grid-body no-border">
                            <form action="guardar_equipo.php" method="post" id="form_traditional_validation">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="input-with-icon  right">                                       
                                      <i class=""></i>
  										<input type="text" name="cod_equipo" id="buscar" class="form-control" required="">                                    
                                  </div>
                                </div>                            
