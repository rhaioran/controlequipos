...
<?php
include("coneccion_bd.php");
  $sql="SELECT * FROM tiposoftware ORDER BY tiposoft ASC";
                ...
                <div class="">
                    <div class="grid simple">
                        ...
                        <div class="grid-body no-border">
                            <form action="guardar_software.php?codigoequipo=<?php echo $codigoequipo ?>" method="post" id="form_traditional_validation">
                                ...
                                <div class="form-actions">  
                                    <div class="pull-right">
                                        <button type="submit" class="btn btn-success btn-cons"><i class="icon-ok"></i>Guardar</button>
                                         <button type="button" class="btn btn-success btn-cons" onClick="location='index_313.php?codigoequipo=<?php echo $codigoequipo ?>'"><i class="icon-ok"></i>Anterior</button>
                                        <button type="button" class="btn btn-success btn-cons" onClick="location='index_324.php?codigoequipo=<?php echo $codigoequipo ?>'"><i class="icon-ok"></i>Siguiente</button>
                                ...
                                <form class="cmxform form-horizontal " id="" method="post" action="guardar_tramo_de_contrato.php">
                                   ...
                                   <table class="table no-more-tables">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                            	<td><?php echo utf8_encode($dato["tipo"]) ?></td> 
