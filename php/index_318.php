                ...
                <div class="">
                    <div class="grid simple">
                        ...
                        <div class="grid-body no-border">
                            <form action="guardar_historial.php?codigoequipo=<?php echo $codigoequipo ?>" method="post" id="form_traditional_validation">
                            
                                <div class="form-group">
                                    <label class="form-label">Fecha: "año-mes-dia ejemplo: 2015-04-15"</label>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="input-with-icon  right">                                       
                                      <i class=""></i>
                                        ...
                                        <label>
                                          <textarea name="tipo" id="tipo" cols="45" rows="2" class="form-control" required=""></textarea>
                                    </label>
                                    </div>
                                </div>
                                <div class="form-group">
