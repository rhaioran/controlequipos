...
<?php
include("coneccion_bd.php");
  $sql="SELECT * FROM tipoperifericos ORDER BY tipoperiferico ASC";
...
window.open(url, "index_337.php",'width='+ancho+',height='+alto+',menubar=0,toolbar=0,directories=0,scrollbars=no,resizable=no,left='+posicion_x+',top='+posicion_y+'');
}
</script>    
...
posicion_x=(screen.width/2)-(ancho/2); 
posicion_y=(screen.height/2)-(alto/2); 
window.open(url, "index_338.php",'width='+ancho+',height='+alto+',menubar=0,toolbar=0,directories=0,scrollbars=no,resizable=no,left='+posicion_x+',top='+posicion_y+'');
}
</script>    
                ...
                <div class="">
                    <div class="grid simple">
                        ...
                        <div class="grid-body no-border">
                            <form action="guardar_periferico.php?codigoequipo=<?php echo $codigoequipo ?>" method="post" id="form_traditional_validation">
                            
                          
                            
                              
                                 <div class="form-group">
                                    <label class="form-label">Tipo de periferico:</label>
                                ...
                                <div class="form-actions">  
                                    <div class="pull-right">
                                        <button type="submit" class="btn btn-success btn-cons"><i class="icon-ok"></i>Guardar</button>
                                         ...
                                         <button type="button" class="btn btn-success btn-cons" onClick="location='index_314.php?codigoequipo=<?php echo $codigoequipo ?>'"><i class="icon-ok"></i>Anterior</button>
    ...
    <!------------------------------------------------------------------------------------------------------------------------>                                
                                <form class="cmxform form-horizontal " id="" method="post" action="guardar_tramo_de_contrato.php">
                                   ...
                                   <table class="table no-more-tables">
                                        <thead>
                                            <tr>
                                            	<th width="10%"><h6 align="center"><b>Tipo</b></h6></th>
                                            	<th width="10%"><h6 align="center"><b>Descripción</b></h6></th>
                                                <th width="10%"><h6 align="center"><b>Dar de baja</b></h6></th>
                                               <?php // <th width="10%"><h6 align="center"><b>Asignar</b></h6></th> ?>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                            	<td><?php echo utf8_encode($dato["tipoperiferico"]) ?></td> 
                                            	<td><?php echo utf8_encode($dato["descripcionperiferico"]) ?></td> 
                                                
                                             	<td><div align="center"><a href="javascript:popup('index_337.php?codigoperiferico=<?php echo $dato["codigoperiferico"] ?>',700,400)"><img border="0" src="assets/img/baja.png"onMouseOver="this.src='assets/img/baja.png';" onMouseOut="this.src='assets/img/baja.png';"width="40" height="40" ></a></div></td>  
                                               <?php // <td><div align="center"><a href="javascript:popup2('index_338.php?codigoequipo=<?php echo $dato["codigoequipo"] ?>',800,500)"><img border="0" src="assets/img/asignar.png"onMouseOver="this.src='assets/img/asignar.png';" onMouseOut="this.src='assets/img/asignar.png';"width="40" height="40" ></a></div></td>  ?>
                                            </tr>
                                              <?php 
                                                } 
                                                ?>
