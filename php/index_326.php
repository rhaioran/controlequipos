...
$res=mysqli_query($conexion,"select * from personas where codigopersona='$codigopersona'")or die("error: ".mysql_error());
while ($dato=mysqli_fetch_array($res))
{
	$nombre		= $dato['nombrepersona'];
	$paterno 	= $dato['apellidopaterno'];
	$materno	= $dato['apellidomaterno'];
	$direccion	= $dato['codigodireccion'];
}

$res=mysqli_query($conexion,"SELECT DISTINCT
...
direcciones.codigodireccion='$direccion'

")or die("error: ".mysql_error());
while ($dato=mysqli_fetch_array($res))
{
	$nombredireccion	= $dato['nombredireccion'];
        ...
        <div class="modal-body">
          <div class="notification-messages success">
            ...
            <div class="message-wrapper">
              ...
              <div > Puede cambiar la contraseña cada cierto tiempo, una vez que guarde la nueva contraseña cuando ingrese nuevamente al sistema puede utilizar la nueva contraseña. </div>
            </div>
            ...
            <form action="guardar_locacion.php" method="post" id="form_traditional_validation">
              <div class="form-group">
                ...
                <div class="input-with-icon  right"> <i class=""></i>
                  <input type="text" name="codigo" id="codigo" class="form-control" required="" value="<?php echo utf8_encode(''.$nombre.' '.$paterno.' '.$materno.'') ?>" readonly>
                </div>
              </div>
              <div class="form-group">
                ...
                <span class="help"></span>
                <div class="input-with-icon  right"> <i class=""></i>
                  <input type="text" name="locacion" id="locacion" class="form-control" required="" value="<?php echo utf8_encode(''.$nombredireccion.' - '.$nombreunidad.' - '.$nombrelocacion.'') ?>" readonly >
