...
<link rel="stylesheet" type="text/css" href='assets/js/default.css' />
	<link rel="stylesheet" type="text/css" href='assets/js/jquery-ui-1.7.2.custom.css' />
                ...
                <div class="">
                    <div class="grid simple">
                        ...
                        <div class="grid-body no-border">
                            <form action="guardar_historial_insidencia.php?codigoequipo=<?php echo $codigoequipo ?>" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-with-icon  right">                                       
                                        <i class=""></i>
                                        <input type="text" name="fecha" id="fecha" class="form-control" placeholder="año-mes-dia"  readonly value="<?php echo $fecha_de_atencion ?>">                                 
                                    </div>
                                </div>  
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-with-icon  right">                                       
                                        <i class=""></i>
                                        <input type="text" name="datepicker" id="datepicker" class="form-control" placeholder="año-mes-dia" >                                 
                                    </div>
                                </div>                          
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="input-with-icon  right">                                       
                                      <i class=""></i>
                                        ...
                                        <label>
                                          <textarea name="tipo" id="tipo" cols="45" rows="2" class="form-control"  readonly><?php echo $descripcionproblema ?></textarea>
                                    </label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-with-icon  right">                                       
                                        <i class=""></i>
                                       <label>
                                          <textarea name="descripcion" id="descripcion" cols="45" rows="2" class="form-control" ></textarea>
                                    </label>
                                ...
                                <div class="form-actions">  
                                    <div class="pull-right">
                                    <button type="submit" class="btn btn-success btn-cons"><i class="icon-ok"></i>Problema Resuelto</button>
                                  </div>
                                </div>
                                </form>
                                
                                    <form action="guardar_atencion.php?codigoequipo=<?php echo $codigoequipo ?>" method="post" id="pp">
                                    <div class="form-group">
                                    <label class="form-label">Descripción Pendiente</label>
                                    <span class="help"></span>
                                    <div class="input-with-icon  right">                                       
                                        <i class=""></i>
                                       <label>
                                          <textarea name="pendiente" id="pendiente" cols="45" rows="2" class="form-control" ></textarea>
                                    </label>
								...
								<div class="form-actions">  
                                    <div class="pull-right">
                                <button type="submit" class="btn btn-success btn-cons"><i class="icon-ok"></i>Problema Pendiente</button>
                                   ...
                                   <table class="table no-more-tables">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="7%"><h6 align="center"><b>Fecha</b></h6></th>
