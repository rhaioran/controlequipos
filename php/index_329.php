...
posicion_x=(screen.width/2)-(ancho/2); 
posicion_y=(screen.height/2)-(alto/2); 
window.open(url, "index_330.php",'width='+ancho+',height='+alto+',menubar=0,toolbar=0,directories=0,scrollbars=no,resizable=no,left='+posicion_x+',top='+posicion_y+'');
}
</script>
                                    ...
                                    <table width="103%" class="table table-hover table-condensed table-striped tab-pane" id="example">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="3%"><h6 align="center"><b>Problema de funcionamiento?</b></h6></th>
                                                <th width="3%"><h6 align="center"><b>Verificar la atención</b></h6></th>
                                        ...
                                        <tbody>
                                            ...
                                            <td><?php echo ''.utf8_encode($dato["apellidopaterno"]).' '.utf8_encode($dato["apellidomaterno"]).' '.utf8_encode($dato["nombrepersona"]).'' ?></td>             
                                              ...
                                              <td><div align="center"><a href="javascript:popup2('index_330.php?codigoequipo=<?php echo $dato["codigoequipo"] ?>',850,500)"><img border="0" src="assets/img/piezas.png"onMouseOver="this.src='assets/img/piezas.png';" onMouseOut="this.src='assets/img/piezas.png';"width="40" height="40" ></a></div></td>  
                                              <td><div align="center"><a href="javascript:popup2('index_332.php?codigoequipo=<?php echo $dato["codigoequipo"] ?>',850,500)"><img border="0" src="assets/img/generado.png"onMouseOver="this.src='assets/img/generado.png';" onMouseOut="this.src='assets/img/generado.png';"width="40" height="40" ></a></div></td>  
