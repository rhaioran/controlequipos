                ...
                <div class="">
                    <div class="grid simple">
                        <div class="grid-title no-border">
                            <h4> Dar de baja pieza de equipo
                        ...
                        <div class="grid-body no-border">
                            <form action="guardar_baja_piesa.php?codigopieza=<?php echo $codigopieza ?>" method="post" id="form_traditional_validation">
                              
 
                                
                                <div class="form-group">
                                    <label class="form-label">Motivo de Baja de la Pieza:</label>
