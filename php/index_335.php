                ...
                <div class="">
                    <div class="grid simple">
                        ...
                        <div class="grid-body no-border">
                            <form action="guardar_baja.php?codigoequipo=<?php echo $codigoequipo ?>" method="post" id="pp">
                              
 
                                
                                <div class="form-group">
                                    <label class="form-label">Motivo de Baja del equipo:</label>
