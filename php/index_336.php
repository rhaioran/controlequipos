...
include("coneccion_bd.php");
  ...
  {  
  	...
  	$name	= $row["apellidopaterno"];
	$name2	= $row["apellidomaterno"];
	$name3	= $row["nombrepersona"];
  	$options2.='<option value='.$id.'>'.$name.' '.$name2.' '.$name3.'</option>';
  }
?>
<!DOCTYPE html>
<html>
            ...
            <div class="modal-body">
                <div class="notification-messages success">
                    ...
                    <div class="message-wrapper">
                        ...
                        <div >
                            Aqui puede transferir el equipo de un funcionario a otro.
                        </div>
                    </div>
                ...
                <div class="">
                    <div class="grid simple">
                        ...
                        <div class="grid-body no-border">
                            <form action="guardar_transferencia_equipo.php?codigoequipo=<?php echo $codigoequipo ?>" method="post" id="form_traditional_validation">
