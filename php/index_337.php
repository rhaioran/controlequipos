            ...
            <div class="modal-body">
                <div class="notification-messages success">
                    ...
                    <div class="message-wrapper">
                        <div class="heading">
                            Baja de piesa de un equipo:
                        </div>
                        <div >
                            Aqui da de baja a las piezas pertenecientes a un equipo, estas dejaran de estar anexas al equipo pero guardaran un historial.
                        </div>
                    </div>
                ...
                <div class="">
                    <div class="grid simple">
                        ...
                        <div class="grid-body no-border">
                            <form action="guardar_baja_periferico.php?codigoperiferico=<?php echo $codigoperiferico ?>" method="post" id="form_traditional_validation">
                              
 
                                
                                <div class="form-group">
                                    <label class="form-label">Motivo de Baja del Periferico:</label>
                                    <span class="help"></span>
                                    <div class="input-with-icon  right">                                       
                                        <i class=""></i>
                                        <label>
                                          <textarea name="descripcion" id="descripcion" cols="45" rows="4" class="form-control" required=""></textarea>
                                      </label>
